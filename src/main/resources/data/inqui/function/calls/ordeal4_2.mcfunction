...
execute as @e[tag=ordeal_runner,limit=1] at @p unless score !finale no_ordeal matches 1 run summon spore:howit_arm ~ ~-10 ~ {PersistenceRequired:1b}
execute as @e[tag=ordeal_runner,limit=1] at @p unless score !finale no_ordeal matches 1 run summon spore:howit_arm ~ ~-10 ~ {PersistenceRequired:1b}
execute as @e[tag=ordeal_runner,limit=1] at @p unless score !finale no_ordeal matches 1 if score !finale proto matches 70.. run summon spore:inf_player ~ ~25 ~-75 {Tags:["inf_pla_boss"],DeathLootTable:"inqui:entities/red_fixer",Silent:1b,PersistenceRequired:1b,CustomName:'{"text":"FIXER","color":"red"}',CustomNameVisible:0b,ArmorItems:[{id:"spore:inf_up_boots",Count:1b},{id:"spore:inf_up_pants",Count:1b},{id:"spore:inf_up_chest",Count:1b},{id:"spore:inf_up_helmet",Count:1b}],HandItems:[{id:"spore:cleaver",Count:1b},{id:"spore:vigil_eye",Count:1b}]}
execute as @e[tag=ordeal_runner,limit=1] at @p unless score !finale no_ordeal matches 1 if score !finale proto matches 140.. run summon spore:howit_arm ~ ~-10 ~ {PersistenceRequired:1b}
execute as @e[tag=ordeal_runner,limit=1] at @p unless score !finale no_ordeal matches 1 if score !finale proto matches 140.. run summon spore:howit_arm ~ ~-10 ~ {PersistenceRequired:1b}
execute as @e[tag=ordeal_runner,limit=1] at @p unless score !finale no_ordeal matches 1 if score !finale proto matches 140.. run summon spore:howit_arm ~ ~-10 ~ {PersistenceRequired:1b}
execute as @e[tag=ordeal_runner,limit=1] at @p unless score !finale no_ordeal matches 1 if score !finale proto matches 210.. run summon spore:howit_arm ~ ~-10 ~ {PersistenceRequired:1b}
execute as @e[tag=ordeal_runner,limit=1] at @p unless score !finale no_ordeal matches 1 if score !finale proto matches 210.. run summon spore:howit_arm ~ ~-10 ~ {PersistenceRequired:1b}
execute as @e[tag=ordeal_runner,limit=1] at @p unless score !finale no_ordeal matches 1 if score !finale proto matches 210.. run summon spore:howit_arm ~ ~-10 ~ {PersistenceRequired:1b}
execute as @e[tag=ordeal_runner,limit=1] at @p unless score !finale no_ordeal matches 1 if score !finale proto matches 280.. run summon spore:inf_player ~ ~15 ~-75 {Tags:["inf_pla_boss"],DeathLootTable:"inqui:entities/red_fixer",Silent:1b,PersistenceRequired:1b,CustomName:'{"text":"FIXER","color":"red"}',CustomNameVisible:0b,ArmorItems:[{id:"spore:inf_up_boots",Count:1b},{id:"spore:inf_up_pants",Count:1b},{id:"spore:inf_up_chest",Count:1b},{id:"spore:inf_up_helmet",Count:1b}],HandItems:[{id:"spore:cleaver",Count:1b},{id:"spore:vigil_eye",Count:1b}]}
