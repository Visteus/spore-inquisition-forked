...
kill @s
#offering corruption is config-driven (offer2). With automatic finalitas OFF, an offering given at
#max corruption (396 = 99%) begins the finale instead of merely adding corruption.
execute unless score !finale auto_finalitas matches 0 run scoreboard players operation !finale proto += !finale offer2
execute if score !finale auto_finalitas matches 0 if score !finale proto matches ..395 run scoreboard players operation !finale proto += !finale offer2
